...
paymentRoutes.post('/balance/in-person', authenticate, (req, res) =>
  paymentController.scheduleInPersonBalance(req as any, res)
);
paymentRoutes.post('/balance/confirm-in-person', authenticate, (req, res) =>
  paymentController.confirmInPersonBalance(req as any, res)
);
